...
```sh
git clone https://github.com/alpredovandy/codefiles/lazynvim.git ~/.config/nvim
```

Or use the following command to install the config:

```sh
git clone https://github.com/alpredovandy/codefiles/lazynvim.git ~/.config/lazyvim
...
docker run -w /root -it --rm alpine:latest sh -uelic '
  ...
  git clone https://github.com/alpredovandy/codefiles/lazynvim ~/.config/nvim
  nvim
  '
```
